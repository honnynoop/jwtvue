...
public class SwaggerConfiguration {
	...
	public OpenAPI openAPI() {
		Info info = new Info().title("SSAFY Board API 명세서").description(
				"<h3>SSAFY API Reference for Developers</h3>Swagger를 이용한 Emp API<br><img src=\"/assets/img/ssafy_logo.png\" width=\"150\">")
				.version("v1").contact(new io.swagger.v3.oas.models.info.Contact().name("honey")
...
//		return GroupedOpenApi.builder().group("ssafy-admin").pathsToMatch("/employ/**").build();
//	}
//
//	@Bean
...
//	}
	...
	public GroupedOpenApi boardajaxApi() {
		return GroupedOpenApi.builder().group("ssafy-emp").pathsToMatch("/api/**").build();
	}
}