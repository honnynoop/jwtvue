...
public class WebMvcConfiguration implements WebMvcConfigurer {
	...
	//private final List<String> patterns = Arrays.asList("/board/*", "/admin", "/user/list","/boardajax");
...
//				.allowedMethods("*")
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        .addResourceLocations("classpath:/static/assets/img/"); // 올바른 경로로 수정
        
        registry.addResourceHandler("/css/**")
        .addResourceLocations("classpath:/static/assets/css/"); // 올바른 경로로 수정
